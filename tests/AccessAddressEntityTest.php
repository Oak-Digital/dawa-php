...
final class AccessAddressEntityTest extends TestCase
{
    ...
    {
        $address = new AccessAddress($this->json_data);
     ...
     */
    public function testAddressData(AccessAddress $address)
    {

        // ID
        $this->assertEquals(
            '0a3f507a-c359-32b8-e044-0003ba298018',
            $address->getID()
        );

        // Path
        $this->assertEquals(
            '/adgangsadresser/0a3f507a-c359-32b8-e044-0003ba298018',
            $address->getPath()
        );
        ...
        $this->assertEquals(
            '153169',
            $address->getESREjendomsnr()
        );

        // Matrikelnr
        $this->assertEquals(
            '13',
            $address->getMatrikelnr()
        );
